			...
			<div class="row">
				<div class="col-lg-12 col-md-12  col-sm-12  col-xs-12 ">
					<div style="border:5px solid #48cae4; border-radius: 20px; height:650px;
								background-image: url('./images/yes.png'); background-size: 100% 100%;">
				<p style="text-align: center; font-size: 35px; padding:50px; color:#a5a5a5;"> 고민을 종이배와 함께 완전히 떠나보냈습니다!</p>
				...
				<div class="col-lg-4 col-md-4  col-sm-4  col-xs-4 ">		
					<a href="check"><button type="button" class="btn btn-primary" 
	                     style="width:100%; font-size:25px; border:4px solid #a2d2ff; background-color:white; color:black; margin-top:30px;">다시 답장 확인하기</button></a>
				</div>
				<div class="col-lg-4 col-md-4  col-sm-4  col-xs-4 ">		
					<a href="garden"><button type="button" class="btn btn-primary" 
	                     style="width:100%; font-size:25px; border:4px solid #a2d2ff; background-color:white; color:black; margin-top:30px;">나의 화원 확인하기</button></a>
				</div>
